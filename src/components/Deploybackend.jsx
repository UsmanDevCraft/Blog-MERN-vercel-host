...
const Deploybackend = () => {
  return (
    ...
    <div className="container d-flex justify-content-center align-items-center mt-5 mb-3">
        <img src="/blog_ss_01.png" className="home-img" alt="..."></img>
    </div>

    <p className='text-center fs-3 text-white'>OR</p>

    <div className="container d-flex justify-content-center align-items-center mt-3">
        <img src="/blog_ss_02.png" className="home-img" alt="..."></img>
    </div>
    ...
    <div className="container d-flex justify-content-center align-items-center mt-3">
        <img src="/blog_ss_03.png" className="home-img" alt="..."></img>
    </div>
    ...
    <div className="container d-flex justify-content-center align-items-center mt-3">
        <img src="/blog_ss_04.png" className="home-img" alt="..."></img>
    </div>
    ...
    <div className="container d-flex justify-content-center align-items-center mt-3">
        <img src="/blog_ss_06.png" className="home-img" alt="..."></img>
    </div>
    ...
    <div className="container d-flex justify-content-center align-items-center mt-3">
        <img src="/blog_ss_07.png" className="home-img" alt="..."></img>
    </div>

    <p className='text-left my-3 fs-3 text-white'>Step 7: You will see this in your dashboard.</p>
    <div className="container d-flex justify-content-center align-items-center mt-3">
        <img src="/blog_ss_08.png" className="home-img" alt="..."></img>
    </div>
    ...
    <div className="container d-flex justify-content-center align-items-center mt-4">
        <div className="card w-75 mb-3 card-bg-color">
            ...
            <div className="container d-flex justify-content-center align-items-center mt-3">
                <img src="/blog_ss_vercel.png" className="home-img" alt="..."></img>
            </div>
            </div>
        </div>
    </div>
    ...
    <div className="container d-flex justify-content-center align-items-center mt-3">
        <img src="/blog_ss_09.png" className="home-img" alt="..."></img>
    </div>
